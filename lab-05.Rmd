...
5.  Add a second variable to your visualization from Exercise 3 based on whether the laureate was born in the US or not.
  ...
  yes, Because we at BuzzFeed we analyze the data to search for more data and get information from it depending on the available data, we go in depth, dig and make a lot of filtering to understand the data.
